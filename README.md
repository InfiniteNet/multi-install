...
```
sudo apt upgrade -y && sudo apt update && sudo apt install -y git && git clone https://github.com/InfiniteNet/multi-install.git && cd multi-install && sudo chmod +x install.sh && ./install.sh
```
